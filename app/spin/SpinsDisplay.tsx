        ...
        <div className="w-3/4 max-w-[140px] flex flex-col gap-2">
          <div>
            <div
              ...
              style={{
                background:
                  "linear-gradient(#301402, #301402) padding-box, linear-gradient(to bottom, #670F04, #CD1E08) border-box",
          ...
          {spinCount >= 50 ? (
            <div className="flex justify-center">
              <div className="relative">
                <div
                  className="relative text-xs font-medium px-3 py-1 rounded-2xl flex items-center gap-1"
                  style={{
                    background:
                      "linear-gradient(#301402, #301402) padding-box, linear-gradient(to bottom, #670F04, #CD1E08) border-box",
                    border: "1px solid transparent",
              ...
              <div className="relative h-5 rounded-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span
                    ...
                    key={timerKey}
                  >
                    5 spins in {formatTime(internalTimer)}
                  </span>
                </div>
              </div>
            </div>
